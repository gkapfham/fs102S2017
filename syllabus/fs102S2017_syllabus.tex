...
\begin{itemize}
  ...
  \item {\em Writing Assignments}: Students will write a wide variety of articles that they will feature on their
    ...
    in the form of GitHub issues and commits --- that document the discussion and revision of each assignment. Along
    with a grade for each assignment, the instructor will return a marked version of the article and, when appropriate,
    raise additional issues in the student's GitHub repository.
