...
\MYTITLE{Assignment 3\\Assigned: Wednesday, February 15, 2017\\Due: Wednesday, February 24, 2017 at the start of class}
...
Consisting of between 800 and 1000 words, your article should contain approximately four or five paragraphs of writing.
...
\section*{Writing a New Feature Article}
...
\begin{enumerate}
  ...
  \item Using your terminal window, please go to the directory that contains the files for your web site. Now, find and
    ...
    using for your web site. Using your previous files as an example, create a new file that you can use to store your
    writing for this assignment. That is, you should use the file browser (or, the ``{\tt mv}'' command if you have
    experience with it) to rename the past file to one that would be appropriate for your new article. Please consider
    naming your file according to the title that you developed during our brainstorming sessions.
...
\begin{enumerate}
  ...
  \item A 600 to 1000 word article that convincingly explains the downsides of using Google products.
